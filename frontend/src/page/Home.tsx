...
export default function Home() {
    ...
    return (
        <>
            <div className="bg-[url(./bg-home.png)] rounded-b-[30px] bg-cover bg-center bg-no-repeat min-h-screen flex flex-col items-center justify-center">

                <h1 className="text-custom_blue_light text-5xl text-center font-bold
